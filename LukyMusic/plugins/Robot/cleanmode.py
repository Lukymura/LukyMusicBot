...
from LukyMusic import app, userbot
from LukyMusic.misc import SUDOERS
from LukyMusic.utils.database import (get_active_chats,
                                       ...
                                       update_user_top)
from LukyMusic.utils.decorators.language import language
from LukyMusic.utils.formatters import alpha_to_int
...
async def braodcast_message(client, message, _):
    ...
    if "-assistant" in message.text:
        ...
        text = _["broad_3"]
        from LukyMusic.core.userbot import assistants
